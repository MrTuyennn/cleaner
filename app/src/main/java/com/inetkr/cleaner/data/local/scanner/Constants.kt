...
object Constants {
    ...
    /**
     * Danh sách đen được kích hoạt mặc định - phiên bản rút gọn của blacklistDefault
     * Chỉ bao gồm các pattern quan trọng nhất để tránh xóa nhầm file quan trọng
     */
    ...
    /**
     * Danh sách trắng mặc định - các file/thư mục được bảo vệ khỏi việc xóa
     * Hiện tại để trống, người dùng có thể tự thêm
     */
    val whitelistDefault: Set<String> = emptySet()
    val whitelistOnDefault: Set<String> = emptySet()
    
    /**
     * Bộ lọc file APK - các định dạng file ứng dụng Android
     * Bao gồm: .aab, .apk, .apks, .apkm
     */
    ...
    /**
     * Bộ lọc file chung - các loại file tạm thời và log
     * Bao gồm: .tmp, .log
     */
    ...
    /**
     * Bộ lọc thư mục chung - các thư mục chứa file tạm thời và log
     * Bao gồm: Logs, logs, temp, Temporary, temporary
     */
    ...
    /**
     * Từ khóa tự động bảo vệ - các từ khóa trong tên thư mục sẽ được tự động bảo vệ
     * Bao gồm: backup, copy, copies, important, do_not_edit, .stfolder
     */
